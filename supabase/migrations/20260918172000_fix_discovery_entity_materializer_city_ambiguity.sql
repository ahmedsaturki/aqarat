...
begin
  ...
  if property_id is null then
    ...
    update public.properties set
      ...
      city=coalesce(v_city,public.properties.city),
  ...
  if phone is not null then
    ...
    if person_id is null then
      ...
      values(null,'unknown'::person_role,v_city,'Created from discovery entity',confidence)
